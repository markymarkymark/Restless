function params = ME_spm8_normalise(VG,VF,matname,VWG,VWF,flags)
...
params = struct('Affine',Affine, 'Tr',Tr, 'VF',VF, 'VG',VG, 'flags',flags);
params = struct('Affine',Affine, 'Tr',Tr, 'VF',VF, 'VG',VG, 'flags',flags,'M',M,'scal',scal);
