function hdr = ME_spm8_dicom_headers4(P)
...
%  - Stripped out stuff to speed up for use by RTfmri
...
% MELLIOTT - added more fields
            case {'CSAImageHeaderInfo', 'CSASeriesHeaderInfo','Private_0029_1210','Private_0029_1220','Private_0029_1110','Private_0029_1120','Private_0029_1010','Private_0029_1020'},
...
%                                [y,m,d] = strread(dat,'%4d%2d%2d');
                                [y,m,d,xtmpx] = strread(dat,'%4d%2d%2d%s'); % fix by MELLIOTT for dates like '20010304\20010304'
                                dat     = datenum(y,m,d);
                            case {'TM'},
                                if any(dat==':'),
...
%                                    [h,m,s] = strread(dat,'%2d%2d%f');
                                    [h,m,s,xtmpx] = strread(dat,'%2d%2d%f%s');
                                end;
